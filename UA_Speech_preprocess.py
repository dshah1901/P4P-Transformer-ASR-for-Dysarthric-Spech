...
def get_data_UA(wavs):
    ...
    for wav in wavs:
        ...
        if text == -1:
            ...
            data_train.append({'audio': aug_noise, 'text': text})
            data_train.append({'audio': aug_timeShift, 'text': text})
            data_train.append({'audio': aug_timeStretch, 'text': text})
            data_train.append({'audio': aug_pitchShift, 'text': text})
