...
libre =  glob("./datasets/LibriSpeech/train-clean-100/*/*/*.txt", recursive=True)
...
for file in libre:
    ...
    for line in f:
        ...
        libri_data.append({"audio": flac, "text": full_sen})


#copy the above code for test data
"""
...
train_data = data[:split] #make equal to libre_train
test_data = data[split:] #libre test
